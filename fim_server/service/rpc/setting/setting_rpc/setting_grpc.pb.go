...
func (c *settingClient) SettingInfo(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*SettingInfoResponse, error) {
	out := new(SettingInfoResponse)
	err := c.cc.Invoke(ctx, Setting_SettingInfo_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SettingServer interface {
	SettingInfo(context.Context, *Empty) (*SettingInfoResponse, error)
...
func (UnimplementedSettingServer) SettingInfo(context.Context, *Empty) (*SettingInfoResponse, error) {
...
func _Setting_SettingInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SettingServer).SettingInfo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Setting_SettingInfo_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SettingServer).SettingInfo(ctx, req.(*Empty))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Setting_SettingInfo_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "rpc/setting.proto",
}
