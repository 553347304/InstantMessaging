...
type IsInGroupMemberResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *IsInGroupMemberResponse) Reset() {
	*x = IsInGroupMemberResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *IsInGroupMemberResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*IsInGroupMemberResponse) ProtoMessage() {}

func (x *IsInGroupMemberResponse) ProtoReflect() protoreflect.Message {
	mi := &file_rpc_group_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use IsInGroupMemberResponse.ProtoReflect.Descriptor instead.
func (*IsInGroupMemberResponse) Descriptor() ([]byte, []int) {
...
var file_rpc_group_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x08, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x72, 0x70, 0x63, 0x22, 0x4c, 0x0a, 0x16, 0x49,
	0x73, 0x49, 0x6e, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x52, 0x65,
	...
	,
...
var file_rpc_group_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_rpc_group_proto_goTypes = []interface{}{
	(*IsInGroupMemberRequest)(nil),  // 0: user_rpc.IsInGroupMemberRequest
	(*IsInGroupMemberResponse)(nil), // 1: user_rpc.IsInGroupMemberResponse
}
var file_rpc_group_proto_depIdxs = []int32{
	0, // 0: user_rpc.Group.IsInGroupMember:input_type -> user_rpc.IsInGroupMemberRequest
	1, // 1: user_rpc.Group.IsInGroupMember:output_type -> user_rpc.IsInGroupMemberResponse
...
func file_rpc_group_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_rpc_group_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*IsInGroupMemberResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
